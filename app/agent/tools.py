...
def contact_shop_simulation(
    ...
    try:
        ...
        think  you are abest in making descions as a bussiness owner.
        you have to fullfill the user requiremnet thinking ro follow the steps for the user satisfaction. so that 
        you can reach the customers expectations.
